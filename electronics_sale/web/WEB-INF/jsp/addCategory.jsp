    ...
    <body>
        ...
        <div id="content">
            ...
            <div id="content-header">
                <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/adindex" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="${pageContext.request.contextPath}/adcategory" class="current">TDanh mục</a></div>
                <h1>Thêm Danh Mục</h1>
            </div>
            <!--End-breadcrumbs-->
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form action="${pageContext.request.contextPath}/themdanhmuc" method="post" class="form-horizontal"commandName="newAccount">
                        <div class="widget-content nopadding">
                            <form action="${pageContext.request.contextPath}/themdanhmuc" method="post" class="form-horizontal"commandName="newAccount">
